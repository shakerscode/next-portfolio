      ...
      <div className="md:w-auto lg:w-[1110px] xl:w-[1110px] 2xl:w-[1110px] w-[291px] md:h-[358px] lg:h-[358px] xl:h-[358px] 2xl:h-[358px]">
        ...
        >
          {reviewContent.map((rC, i) => (
            <SwiperSlide
              key={i}
              className="md:w-[820px] lg:w-[1110px] xl:w-[1110px] 2xl:w-[1110px] w-[291px] flex-wrap-reverse flex justify-center items-center gap-[103px] md:gap-[10px] pl-2"
            >
              <div className="bg-white-white md:w-[505px] lg:w-[541px] xl:w-[541px] 2xl:w-[541px] w-[302px] h-[265px] flex flex-col justify-start md:justify-center lg:justify-center xl:justify-center 2xl:justify-center items-center md:px-8 lg:px-8 xl:px-8 2xl:px-8 md:gap-[10px] lg:gap-[10px] xl:gap-[10px] 2xl:gap-[10px] shadow-xl rounded-lg">
                ...
                <p className="font-normal leading-6 text-lg text-gray-600 w-[242px] md:[242px] lg:w-auto xl:w-auto 2xl:w-auto h-[140px] md:h-auto lg:h-auto xl:h-auto 2xl:h-auto mt-[10px] md:mt-0 lg:mt-0 xl:mt-0 2xl:mt-0">
              ...
              <div className="w-[454px] md:w-[292px] h-[232px] pl-10 md:pl-0 lg:pl-0 xl:pl-0 2xl:pl-0">
                <p className="font-medium text-xl leading-10 text-primary-600 text-right">
                  Reviews
                </p>
                <h2 className="font-semibold text-5xl  text-black-600 text-right mt-3">
                  What Client Say
                </h2>
                <p className="font-normal leading-7 text-base text-gray-600 text-right mt-6">
                  Lorem Ipsum has been the industry’s standard dummy text ever
                  since the 1500s, when an unknown printer took a galley of type
                  and scrambled
                </p>
