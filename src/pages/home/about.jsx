...
const About = () => {
    return (
        <section className='md:h-[740px] lg:h-[740px] xl:h-[740px] 2xl:h-[740px] h-[1361px] bg-white-white flex flex-wrap md:flex-nowrap lg:flex-nowrap xl:flex-nowrap 2xl:flex-nowrap justify-center items-center md:gap-8 lg:gap-[90px]  relative'>
            <div className='md:w-[447px] lg:w-[562px] xl:w-[562px] 2xl:w-[562px] mt-[270px] md:mt-0  xl:mt-[70px] 2xl:mt-[70px] lg:mt-[70px] w-[317px]'>
                <Image src={aboutImage} alt="about-image" />
            </div>

            <div className='lg:w-[552px] xl:w-[552px] 2xl:w-[552px] w-[302px] h-[580px] md:w-[398px]  lg:h-auto xl:h-[414px] 2xl:h-[414px] md:h-[461px] flex flex-col gap-[10px] mt-[-170px] xl:mt-[70px] px-5'>
                ...
                <div className=' flex items-center gap-1 md:gap-[20px] lg:gap-[20px] xl:gap-[20px] 2xl:gap-[20px] mt-[10px]'>
                    <div className='lg:w-[276px] '>
                        <div className='flex items-center md:gap-[18px] lg:gap-[18px] xl:gap-[18px] 2xl:gap-[18px] gap-1 text-gray-600 font-normal text-lg leading-[24px] text-left'>
                    ...
                    <div className='flex flex-col gap-[23px] mt-[10px]'>
                        <div className='md:w-[250px] lg:w-[250px] xl:w-[250px] 2xl:w-[250px] w-[146px] bg-white-white h-[7px] rounded-full border-2 border-primary-600'>
                            <div className='w-[132px] md:w-[225px] lg:w-[225px] xl:w-[225px] 2xl:w-[225px] h-full mr-6 rounded-full bg-primary-600'></div></div>
                        <div className='md:w-[250px] lg:w-[250px] xl:w-[250px] 2xl:w-[250px] w-[146px] h-[7px] rounded-full border-2 border-primary-600'><div className='w-[117px] md:w-[225px] lg:w-[225px] xl:w-[225px] 2xl:w-[225px] h-full mr-10 rounded-full bg-primary-600'></div></div>
                        <div className='md:w-[250px] lg:w-[250px] xl:w-[250px] 2xl:w-[250px] w-[146px] h-[7px] rounded-full border-2 border-primary-600'><div className='w-[123px] md:w-[225px] lg:w-[225px] xl:w-[225px] 2xl:w-[225px] h-full mr-8 rounded-full bg-primary-600'></div></div>
                    </div>
                </div>
            ...
            <div className='lg:w-[1140px] w-[210px] md:w-fit-content md:px-14 md:h-[178px] lg:h-[178px] xl:h-[178px] 2xl:h-[178px] bg-white-white rounded-full h-[614px] flex-col md:flex-row lg:flex-row xl:flex-row 2xl:flex-row flex lg:justify-evenly md:justify-between md:gap-7 gap-[50px]  items-center absolute top-[-22%] md:top-[-13%] footer-shadow'>
