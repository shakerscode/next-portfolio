    ...
    return (
        <section className='bg-secondary-600 h-[895px] flex flex-col justify-center items-center gap-[80px]'> 
                <div className='w-[783px]'>
                    ...
                    <h1 className='text-[48px] font-semibold text-black-600 leading-[45px] text-center mt-[10px]'>What I Can Do</h1>
                ...
                <div className='flex justify-center items-center gap-[50px] w-[1140px] h-[377px]'>
                    {
                        cardDetails.map((cD, i) =>
                            <div key={i} className={`${i === 0 ? "shadow-2xl" : ""} flex flex-col justify-center items-center gap-[15px] w-[347px] h-[377px] bg-white-white rounded-md hover:shadow-2xl cursor-pointer active:shadow-xl `}>
                                <div>
