...
const Service = () => {
    ...
    return (
        <section className='bg-secondary-600 h-[895px] flex flex-col justify-center items-center gap-[80px] relative main-bg '> 
                <div className='w-[783px]'>
                    ...
                    <p className='w-[675px] text-lg font-normal text-gray-600 leading-[24px] text-center mt-[20px]'>I have 2 years of experience in Ui Ux Design services such as Desktop Interface Designs, Mobile / Tablet UI Design, Interface Wireframes, and Prototyping. </p>
                </div>
                <div className='flex justify-center items-center gap-[50px] w-[1140px] h-[377px]'>
                    {
                        cardDetails.map((cD, i) =>
                            <div onMouseOver={() => setNumber(i)} key={i} className={`${i === number ? "shadow-2xl" : ""} flex flex-col justify-center items-center gap-[15px] w-[347px] h-[377px] card-z-index bg-white-white rounded-md hover:shadow-2xl cursor-pointer active:shadow-xl  `}>
                                <div>
