    ...
    return (
        <section id='home' className='md:h-[761px] h-[1369px] lg:h-[731px] xl:h-[731px] 2xl:h-[731px] md:px-5 lg:px-0 xl:px-0 2xl:px-0 px-5  bg-secondary-600 flex flex-wrap md:flex-nowrap lg:justify-center xl:justify-center 2xl:justify-center md:justify-center justify-start items-center lg:gap-[42px] mg:gap-0  relative pt-[60px] md:pt-none lg:pt-none xl:pt-none 2xl:pt-none'>
            <div className='md:w-[400px] md:h-[448px] lg:w-[557px] xl:w-[557px] 2xl:w-[557px] w-auto lg:h-[372px] h-fit-content flex flex-col gap-[20px] mb-auto md:md-none lg:md-none xl:md-none 2xl:md-none'>
                ...
                <p className='text-gray-600 font-normal text-lg leading-[30px] md:w-[395px] md:h-[90px] text-left'>My aim is to create better interfaces and experiences, making the web and mobile applications easier and more pleasant to use.</p>
