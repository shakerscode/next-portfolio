    ...
    return (
        <header className='w-{100%} h-[120px] bg-secondary-600 flex justify-around items-center'>
            ...
            <div className='flex justify-center items-center gap-[50px]'>
                ...
                <button className='h-[54px] w-[170px] text-primary-600 bg-gradient-to-r from-red-500 to-red-600 border-2 border-gradient-to-r from-red-500 to-red-600 rounded-full shadow-[0px 15px 30px 0px #C63B2321]'>
                    HIRE ME
                </button>
            </div>
        </header >
