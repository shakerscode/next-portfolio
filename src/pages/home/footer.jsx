...
const Footer = () => {
    return (
        <footer id='footer' className='md:h-[196px] lg:h-[196px] xl:h-[196px] 2xl:h-[196px] h-[434px] bg-secondary-600 flex justify-center items-center relative'>
            <a href='#home' className='absolute md:top-[-27%] lg:top-[-22%] xl:top-[-22%] 2xl:top-[-22%] md:right-2 lg:right-2 xl:right-2 2xl:right-2 w-[80px] md:w-[112px] lg:w-[112px] xl:w-[112px] 2xl:w-[112px] md:h-[112px] lg:h-[112px] xl:h-[112px] 2xl:h-[112px] right-[0px] top-[-9%] cursor-pointer' id='#home'>
            <Image src={up} alt="down-up"/>
            </a>
