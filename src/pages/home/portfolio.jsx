...
const Portfolio = () => {
    return (
        <section className='h-[875px] w-[100%] flex flex-col m-auto justify-center gap-20 mx-auto bg-white-white'>
            <div className='flex flex-wrap md:flex-nowrap lg:flex-nowrap xl:flex-nowrap 2xl:flex-nowrap justify-start md:justify-between lg:justify-between xl:justify-between 2xl:justify-between md:w-[1140px] xl:w-[1140px] lg:w-[1140px] 2xl:w-[1140px] items-center mx-auto'>
                <div>
            ...
            <div className='md:w-[1138px] lg:w-[1138px] xl:w-[1138px] 2xl:w-[1138px] w-full h-[450px] flex justify-center items-center mx-auto' >
                <Swiper
                    effect={"coverflow"}
                    grabCursor={true}
                    coverflowEffect={{
